...
nameit=case_roms_nolake;nameit2=expname2;
grd=rnt_gridload2(nameit,case_roms,case_roms_nolake,case_wrf,path_roms_case,path_roms_nolake_case,path_wrf_case);
grdname=grd.grdfile;
title='';
