      ...
      real init_time, nhour2, nhour, jd
...
! 1. open existing forc.nc file
       status = nf_open('fort.15',nf_write,ncid)
...
! 3. insert jd
        ...
        init_time= real(jd) + nhour2
        print *, "init_time= ", forc_time
      !status = nf_put_var_int(ncid,varid,init_time)
