...
# fixed the bug Occt 28, 2022
# YYYYi --> YYYYin

$Couple_Lib_utils_Dir/incdte $YYYYin $MMin $DDin $HHin -$CF > dteout$$ || exit 8
#n : 1 $CF earlier than
...
if [ -s $WW3_In ]; then
	...
	echo "it is OKAY that WW3_In is empty @ NLOOP = 1 because WW3_spinup = no"
	else
