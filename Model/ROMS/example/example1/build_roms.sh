...
setenv ROMS_APPLICATION      EXAMPLE1

# Set a local environmental variable to define the path to the directories
# where all this project's files are kept.

#setenv MY_ROOT_DIR           ${HOME}/ocean/repository
setenv MY_ROOT_DIR           /vortexfs1/share/seolab/crenkl/models/ROMS
...
# to the code and inputs on differing machines.
 ...
 setenv MY_ROMS_SRC          ${MY_ROOT_DIR}/ROMS_march2020
...
# etc).
 ...
 setenv MY_HEADER_DIR       ${MY_PROJECT_DIR}/include
