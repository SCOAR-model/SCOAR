...
# restart using the ocean_rst.nc file # Jul 19, 2017
	...
	ln -fs $ROMS_Rst_Dir/rst_$YYYYi-$MMi-$DDi\_$HHi\_Hour$NHourm\.nc  $Couple_Data_ROMS_Dir/ocean_ini.nc 
...
forcfile=$ROMS_Forc_Dir/forc_$YYYYin-$MMin-$DDin\_$HHin\_Hour$NHour\.nc
