...
if [ $parameter_run_WW3 = yes ]; then
	...
	elif [ $COARE_wave_option = 3 ]; then #wave age, steepness and wind wave alignement  formula
                sed -i -e "$l8 i isftcflx                 =  353," $namelist_input_file
        elif [ $COARE_wave_option = 4 ]; then #wave age, steepness formula using mean period
                sed -i -e "$l8 i isftcflx                 =  354," $namelist_input_file
        elif [ $COARE_wave_option = 5 ]; then #wave age, steepness and wind wave alignement  formula Porchetta et al.
