#!/bin/bash
#SBATCH --job-name=ww3r01# Job name
...
curr_dir=/vortexfs1/share/seolab/hseo/SCOAR2/Run/miso/miso6/miso6_r01/Data/WW3/process
$curr_dir/postprocess_ww3_2019.sh >& log01
