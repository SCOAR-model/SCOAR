...
export gridname=tutorial1
export gridname2=tutorial
...
#                       Turbulent heat fluxes are computed from the ust_ww # option added Oct 24, 2022 
	export isftcflx=352 # or 351, or 352, or 0
...
if [ $Tide = yes ]; then
  ...
  export tide_data=/vortexfs1/share/seolab/csauvage/SCOAR_GIT/SCOAR/Data/domains/$gridname2/$gridname/ROMS_Input/tides.nc
fi
...
if [ $restart_from_coupled_spinup = yes ]; then
  ...
  export ROMS_ICFile=/vortexfs1/share/seolab/csauvage/SCOAR_GIT/SCOAR/Data/domains/$gridname2/$gridname/ROMS_Input/mercator.ini_1dy_20181201.nc
  # CR 2023-09-21: NEW option:
  # set `ROMS_PERFECT_RESTART=yes` if ROMS_ICFile is a restart file from a
  # ROMS simulation with cpp flag `PERFECT_RESTART`.
  export ROMS_PERFECT_RESTART=no
fi
...
export WW3_spinup=yes
	...
	export WW3_ICFile=/vortexfs1/share/seolab/csauvage/SCOAR_GIT/SCOAR/Data/domains/$gridname2/$gridname/WW3_Input/restart030_20181201.ww3
	export WW3_ICFile_NC=/vortexfs1/share/seolab/csauvage/SCOAR_GIT/SCOAR/Data/domains/$gridname2/$gridname/WW3_Input/ww3_norus_spinup_2018.201812.nc
	fi
	...
	export WW3_BCFile=/vortexfs1/share/seolab/csauvage/SCOAR_GIT/SCOAR/Data/domains/$gridname2/$gridname/WW3_Input/nest.ww3
...
# Main Run Directory
export Couple_Run_Dir=/vortexfs1/share/seolab/csauvage/SCOAR_GIT/SCOAR/Run/$gridname2/$gridname/$RUN_ID
...
#Home Directory
export Couple_Home_Dir=/vortexfs1/share/seolab/csauvage/SCOAR_GIT/SCOAR
