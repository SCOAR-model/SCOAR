...
function grd = rnt_gridload(gridid,case_roms,case_roms_nolake,case_wrf,path_roms_case,path_roms_nolake_case,path_wrf_case)
...
grdinfo=rnt_gridinfo2(gridid,case_roms,case_roms_nolake,case_wrf,path_roms_case,path_roms_nolake_case,path_wrf_case);
...
h=nc{'h'}(:)';
f=nc{'f'}(:)';
grd.maskr=nc{'mask_rho'}(:)';grd.maskr(grd.maskr==0)=NaN;
grd.masku=nc{'mask_u'}(:)';  grd.masku(grd.masku==0)=NaN;
grd.maskv=nc{'mask_v'}(:)';  grd.maskv(grd.maskv==0)=NaN;
grd.maskp=nc{'mask_psi'}(:)';grd.maskp(grd.maskp==0)=NaN;
grd.pm=nc{'pm'}(:)';
grd.pn=nc{'pn'}(:)';
pm=nc{'pm'}(:)';
pn=nc{'pn'}(:)';
