...
# 2/2/2020: write_hist_at_0h_rst is set back to 'false' to all restart run (this is done in couple.sh) So WRF2ROMS.sh uses the WRF output file at the end of the forecast (so that the WRF forcing time is consistent with the ROMS forecast time)
